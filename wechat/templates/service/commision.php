...
<body id="personal-page">
    ...
    <div class="weui-panel">
       <div class="weui-panel__bd">
           ...
           <div class="weui-media-box weui-media-box_text point-item commision-item">
               <div class="left">
                  <div class="title">佣金</div>
                  <div class="value">+1000</div>
               </div>
               <div class="middle">
                  <div class="title">报单金额</div>
                  <div class="value">&yen; 1000</div>
               </div>
               <div class="right">
                  <div class="name">报单人：郎朗</div>
               </div>
               <div class="clear"></div>
           </div>
       </div>
