...
<body id="personal-page">
    ...
    <div class="weui-panel">
       <div class="weui-panel__bd">
           <div class="weui-media-box weui-media-box_text point-item-top">
               <div class="left">17091952061</div>
               <div class="right">2016-12-09 10:12:56</div>
               <div class="clear"></div>
           </div>
           <div class="weui-media-box weui-media-box_text point-item">
               <div class="left">
                  <div class="title">投入积分</div>
                  <div class="value">1000</div>
               </div>
               <div class="middle">
                  <div class="title">可获积分</div>
                  <div class="value">1000</div>
               </div>
               <div class="right">
    ...
    <script src="/media/js/point/wait.js?v=<?php echo rand(1,10).'.'.rand(1,10);?>"></script>    
</body>
</html>