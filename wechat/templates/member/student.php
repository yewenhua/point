...
<body id="personal-page">
    ...
    <div class="weui-panel">
       ...
       <p class="wait-point-name">徒弟总数</p>
    </div>
    ...
    <div class="weui-panel">
       <div class="weui-panel__bd">
           <div class="weui-media-box weui-media-box_text exchange-point-item-top">
               <div class="title">用户编号：17091952061</div>
           </div>
           <div class="weui-media-box weui-media-box_text exchange-point-item student-point-item">
               <div class="left">
                  <div class="value">刘德华</div>
               </div>
               <div class="right">
                  <div class="status">加入时间：2016-12-09</div>
               </div>
               <div class="clear"></div>
           </div>
       </div>
    ...
    <script src="/media/js/member/student.js?v=<?php echo rand(1,10).'.'.rand(1,10);?>"></script>    
</body>
</html>