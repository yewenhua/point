...
(function(root, factory) {
	...
	var DateRangePicker = function(element, options, cb) {
		...
		var DRPTemplate =
			...
			'<span class="range_head_sub time-margin-left">时期：</span>' +
			'<span class="white-bg">' +
			'<i class="glyphicon glyphicon-calendar"></i>' +
			'<input type="text" name="daterangepicker_start"/>' +
			'<font>~</font>' +
			'<input type="text" name="daterangepicker_end"/>' +
			'</span>' +
			'<span class="range_head_sub cursor-pointer today">今日</span>' +
			'<span class="range_head_sub cursor-pointer yestoday">昨日</span>' +
			'<span class="range_head_sub cursor-pointer weekbefore">近7日</span>' +
			'<span class="range_head_sub cursor-pointer month">近30日</span>' +
			'<div class="clear"></div>' +
			'</div>' +
			'<div class="clear"></div>' +
			...
			'<div class="clear"></div>' +
			'<div class="range_tail">' +
			'<div class="ranges">' +
			//'<button class="cancelBtn"></button>'+
			'<button class="btn btn-default padder-v-xxs cancelBtn">取消</button>' +
			'&nbsp;' +
			//'<button class="applyBtn" disabled="disabled"></button>'+
			'<button class="btn btn-info padder-v-xxs applyBtn" disabled="disabled"><i class="glyphicon glyphicon-ok"></i>确定</button>' +
			'</div>' +
			'</div>' +
			'</div>';
		...
		$(".today").click($.proxy(this.clickToday, this));
		$(".yestoday").click($.proxy(this.clickYestoday, this));
		$(".weekbefore").click($.proxy(this.clickWeek, this));
		$(".month").click($.proxy(this.clickMonth, this));
	...
	DateRangePicker.prototype = {
		...
		move: function() {
			...
			if (this.opens == 'left') {
				...
				this.container.css({
					top: this.element.offset().top + this.element.outerHeight() - parentOffset.top - 3,
		...
		clickYestoday: function(e) {
			var tmpDate = new Date();
			var startDate = new Date(tmpDate.getTime() - 1000 * 60 * 60 * 24);
		...
		clickWeek: function(e) {
			var tmpDate = new Date();
			var startDate = new Date(tmpDate.getTime() - 1000 * 60 * 60 * 24 * 7);
			var endDate = new Date();
		...
		clickMonth: function(e) {
			var tmpDate = new Date();
			var startDate = new Date(tmpDate.getTime() - 1000 * 60 * 60 * 24 * 30);
			var endDate = new Date();
