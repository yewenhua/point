    ...
    <div class="weui-cells weui-cells_form">
            ...
            <div class="weui-cell">
                <div class="weui-cell__hd"><label class="weui-label">新二级密码</label></div>
                <div class="weui-cell__bd">
                    <input class="weui-input" type="password" id="password" placeholder="请输入新二级密码"/>
                </div>
            </div>
            <div class="weui-cell">
                <div class="weui-cell__hd"><label class="weui-label">新二级密码确认</label></div>
                <div class="weui-cell__bd">
                    <input class="weui-input" type="password" id="re_password" placeholder="请再次输入新二级密码"/>
                </div>
            </div>
        </div>
