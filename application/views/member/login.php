...
<body id="loginpage">
    ...
    <a href="/member/findpwd/member"><div style="margin:12px auto; text-align:right;font-size:13px; color:#333; padding-right:15px;">忘记密码？</div></a>
    
    <script type="text/babel" src="/media/js/member/login.js"></script>
</body>
</html>