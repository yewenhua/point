    ...
    <div class="weui-panel">
       <div class="weui-panel__bd">
               <div class="weui-media-box weui-media-box_text point-item-top record-item-top preview-item-top">
	               ...
	               <div class="right"><?php echo $created_at;?></div>
	               <div class="clear"></div>
	           </div>
               <a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg review-item">
                    ...
                    <div class="weui-media-box__bd">
                        ...
                        <div class="review-price"><?php if($goods['model'] == 1){echo '购物券'.$goods['point_price'].'分';}elseif($goods['model'] == 2){echo '消费积分'.$goods['point_price'].'分';}else{echo '消费积分'.$goods['point_price'].'分 + 现金 &yen;'.round($goods['cash_price'], 2).'元';}?></div>
                    </div>
               </a>
        </div>
    </div>
    ...
    <div class="weui-cells weui-cells_form review-margin-top">
            <div class="weui-cell">
                <div class="weui-cell__hd"><label class="weui-label" style="width:86px;"><?php if($goods['model'] == 1){echo '购物券';}elseif($goods['model'] == 2 || $goods['model'] == 3){echo '消费积分';}?></label></div>
                <div class="weui-cell__bd" style="font-size:15px;"><?php echo $goods['point_price'] * $buy_num;?> 分</div>
            </div>
            
            <?php if($goods['model'] == 3):?>
            <div class="weui-cell">
                <div class="weui-cell__hd"><label class="weui-label" style="width:86px;">商品金额</label></div>
                <div class="weui-cell__bd" style="font-size:15px;">&yen; <?php echo $goods['cash_price'] * $buy_num;?> 元</div>
            </div>
            <?php endif;?>
    ...
    <div class="bottom-btn-area">
        <form action="/orders/create" method="post" id="submit_form">
    ...
    <script>
        ...
        var exchange_point = <?php echo $userInfo['exchange_point'];?>;
        var model = <?php echo $goods['model'];?>;
